...
export declare const updateAdicional: (req: EmpresaRequest, res: Response) => Promise<void>;
export declare const deleteAdicional: (req: EmpresaRequest, res: Response) => Promise<void>;
export {};
