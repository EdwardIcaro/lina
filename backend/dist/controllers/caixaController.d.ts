...
export declare const updateCaixaRegistro: (req: EmpresaRequest, res: Response) => Promise<void>;
export declare const deleteCaixaRegistro: (req: EmpresaRequest, res: Response) => Promise<void>;
